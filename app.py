...
ROLE_RULES = {
    ...
    "trust_detail": {"Admin", "Trustee"},
    "property_detail": {"Admin", "Trustee"},
    ...
    "k1_report_view": {"Admin", "Trustee"},
    "form1041_report_view": {"Admin", "Trustee"},
