...
def init_db():
    ...
    CREATE TRIGGER IF NOT EXISTS property_attestations_no_update BEFORE UPDATE ON property_attestations
      BEGIN SELECT RAISE(ABORT, 'property_attestations_append_only'); END;
    CREATE TRIGGER IF NOT EXISTS property_attestations_no_delete BEFORE DELETE ON property_attestations
      BEGIN SELECT RAISE(ABORT, 'property_attestations_append_only'); END;
    CREATE TRIGGER IF NOT EXISTS property_identification_revisions_no_update BEFORE UPDATE ON property_identification_revisions
      BEGIN SELECT RAISE(ABORT, 'property_identification_revisions_append_only'); END;
    CREATE TRIGGER IF NOT EXISTS property_identification_revisions_no_delete BEFORE DELETE ON property_identification_revisions
      BEGIN SELECT RAISE(ABORT, 'property_identification_revisions_append_only'); END;
    """)
